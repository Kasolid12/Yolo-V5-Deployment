...
def build_model(is_cuda):
    net = cv2.dnn.readNet("best (4).onnx")
    if is_cuda:
...
def load_capture():
    capture = cv2.VideoCapture("Video/Merah_Hijau.mp4")
...
# def draw_centroids_on_image(output_image, output_data):   
#     data = json.loads(output_data) # Converting JSON array to Python List
...
while True:
    ...
    #  draw_centroids_on_image(inputImage, outs[0])
